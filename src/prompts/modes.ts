...
- Step 2: When they reply, evaluate:
    ...
    • INCORRECT → do NOT reveal the answer yet. Use hint ladder:
...
- Format: tight bullet points, not paragraphs. Bold key terms and definitions.
...
- Then provide the reasoning/derivation briefly (the "why").
